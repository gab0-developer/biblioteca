...
<div class="container-form-register">
    <div class="img-biblioteca">
        <img src="{{asset('assets/img/fondobiblioteca4.jpg')}}" alt="">
    </div>

    <div class="caja-form-register">
        <div class="title-form text-center py -2">
            <h4 class="text-info"><strong>Registrarse</strong></h4>
        </div>
        <form action="{{route('register.store')}}" method="post">
            ...
            <div class="btn-submit w-100">
                <input type="submit" id="btn-submit" name="submit_lector" class="btn btn-info w-100" value="Registrarse">
            </div>
